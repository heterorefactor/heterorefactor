...
;
struct __dst_alloc_list__dmemi __dmemi[131072U];
# 1 "<stdin>"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 73 "<stdin>"
unsigned char __dst_alloc_node_split__dmemi[(1 << (17 - 1)) / 8];
...
struct __dst_alloc_list_base_t __dst_alloc_buckets__dmemi[17] = {{1, 1}};
static __dst_alloc_bucket_size_t __dst_alloc_bucket_for_request__dmemi(
        __dst_alloc_size_t request) {
    __dst_alloc_bucket_size_t bucket = 17 - 1;
