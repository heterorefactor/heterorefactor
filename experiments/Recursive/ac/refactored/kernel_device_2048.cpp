...
;
struct __dst_alloc_list__dmemc __dmemc[2049U];
# 1 "<stdin>"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 73 "<stdin>"
unsigned char __dst_alloc_node_split__dmemc[(1 << (11)) / 8];
...
struct __dst_alloc_list_base_t __dst_alloc_buckets__dmemc[11 + 1] = {{1, 1}};
...
{
  volatile struct __rect_packed_type_L5464R__L5465R __rect_packed_var_L5464R__L5465R[128U];
  ...
  if (__rect_packed_var_L5464R__L5465R[0 + __rect_packed_top_L5464R__L5465R] . local3 == '%') {
    ...
    __rect_packed_var_L5464R__L5465R[0 + __rect_packed_top_L5464R__L5465R] . local3 >= 'a' && __rect_packed_var_L5464R__L5465R[0 + __rect_packed_top_L5464R__L5465R] . local3 <= 'z'?(static_cast < void  >  (0)) : __assert_fail("ch >= 'a' && ch <= 'z'","hetero-yYuhFl-kernel.cpp",53,__PRETTY_FUNCTION__);
    ...
    if (__rect_packed_top_L5464R__L5465R + 1U == 128U) {;
g_fallback = true;
      int __temp0__;
      return __temp0__;
    }
...
void query_AhoCorasick(__didxclass_node root,char *query,int *substring_indexes,int *query_indexes)
{
  ...
  for (int offset = 0; ; offset++) {
    ...
    if (ch == '%') 
      break; 
    ch >= 'a' && ch <= 'z'?(static_cast < void  >  (0)) : __assert_fail("ch >= 'a' && ch <= 'z'","hetero-yYuhFl-kernel.cpp",106,__PRETTY_FUNCTION__);
    int idx = ch - 'a';
...
{
  volatile struct __rect_packed_type_L5470R__L5471R __rect_packed_var_L5470R__L5471R[128U];
  ...
  for (__rect_packed_var_L5470R__L5471R[0 + __rect_packed_top_L5470R__L5471R] . local1 = 0; __rect_packed_var_L5470R__L5471R[0 + __rect_packed_top_L5470R__L5471R] . local1 < 26; __rect_packed_var_L5470R__L5471R[0 + __rect_packed_top_L5470R__L5471R] . local1++) {
    if (__rect_packed_top_L5470R__L5471R + 1U == 128U) {;
g_fallback = true;
      return ;
    }
