...
int insert_node(__didxclass_node root,__didxc str,int substring_index)
{
  ...
  if (__rect_packed_var_L5464R__L5465R[0 + __rect_packed_top_L5464R__L5465R] . local3 == '%') {
    ...
    __rect_packed_var_L5464R__L5465R[0 + __rect_packed_top_L5464R__L5465R] . local3 >= 'a' && __rect_packed_var_L5464R__L5465R[0 + __rect_packed_top_L5464R__L5465R] . local3 <= 'z'?(static_cast < void  >  (0)) : __assert_fail("ch >= 'a' && ch <= 'z'","hetero-SCl5UJ-kernel.cpp",53,__PRETTY_FUNCTION__);
...
void query_AhoCorasick(__didxclass_node root,char *query,int *substring_indexes,int *query_indexes)
{
  ...
  for (int offset = 0; ; offset++) {
    ...
    if (ch == '%') 
      break; 
    ch >= 'a' && ch <= 'z'?(static_cast < void  >  (0)) : __assert_fail("ch >= 'a' && ch <= 'z'","hetero-SCl5UJ-kernel.cpp",108,__PRETTY_FUNCTION__);
    int idx = ch - 'a';
