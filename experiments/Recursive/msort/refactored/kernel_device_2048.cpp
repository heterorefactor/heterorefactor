...
;
struct __dst_alloc_list__dmemclass_Node __dmemclass_Node[2049U];
# 1 "<stdin>"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 73 "<stdin>"
unsigned char __dst_alloc_node_split__dmemclass_Node[(1 << (11)) / 8];
...
struct __dst_alloc_list_base_t __dst_alloc_buckets__dmemclass_Node[11 + 1] = {{1, 1}};
...
__didxclass_Node SortedMerge(__didxclass_Node a,__didxclass_Node b)
{
  volatile struct __rect_packed_type_L5446R__L5447R __rect_packed_var_L5446R__L5447R[2048U];
...
/* Pick either a or b, and recur */
  if ((&(__dmemclass_Node + __rect_packed_var_L5446R__L5447R[0 + __rect_packed_top_L5446R__L5447R] . local0 + 0U) -> _data) -> data <= (&(__dmemclass_Node + __rect_packed_var_L5446R__L5447R[0 + __rect_packed_top_L5446R__L5447R] . local1 + 0U) -> _data) -> data) {
    ...
    if (__rect_packed_top_L5446R__L5447R + 1U == 2048U) {;
g_fallback = true;
