...
;
struct __dst_alloc_list__dmemclass_Node __dmemclass_Node[16385U];
# 1 "<stdin>"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 73 "<stdin>"
unsigned char __dst_alloc_node_split__dmemclass_Node[(1 << (14)) / 8];
...
struct __dst_alloc_list_base_t __dst_alloc_buckets__dmemclass_Node[14 + 1] = {{1, 1}};
static __dst_alloc_bucket_size_t __dst_alloc_bucket_for_request__dmemclass_Node(
        __dst_alloc_size_t request) {
    __dst_alloc_bucket_size_t bucket = 14;
