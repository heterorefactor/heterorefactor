...
;
struct __dst_alloc_list__dmemL106R __dmemL106R[1025U];
# 1 "<stdin>"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 73 "<stdin>"
unsigned char __dst_alloc_node_split__dmemL106R[(1 << (10)) / 8];
...
struct __dst_alloc_list_base_t __dst_alloc_buckets__dmemL106R[10 + 1] = {{1, 1}};
