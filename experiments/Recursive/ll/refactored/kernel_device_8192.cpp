...
;
struct __dst_alloc_list__dmemL106R __dmemL106R[16384U];
# 1 "<stdin>"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 73 "<stdin>"
unsigned char __dst_alloc_node_split__dmemL106R[(1 << (14 - 1)) / 8];
...
struct __dst_alloc_list_base_t __dst_alloc_buckets__dmemL106R[14] = {{1, 1}};
...
{
  volatile struct __rect_packed_type_L5458R__L5459R __rect_packed_var_L5458R__L5459R[8192U];
  ...
  if ((&(__dmemL106R + __rect_packed_var_L5458R__L5459R[0 + __rect_packed_top_L5458R__L5459R] . local0 + 0U - 1U) -> _data) -> next == 0L) {
    ...
    if (__rect_packed_top_L5458R__L5459R + 1U == 8192U) {;
g_fallback = true;
