...
;
struct __dst_alloc_list__dmemi __dmemi[2048U];
# 1 "<stdin>"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 73 "<stdin>"
unsigned char __dst_alloc_node_split__dmemi[(1 << (11 - 1)) / 8];
...
struct __dst_alloc_list_base_t __dst_alloc_buckets__dmemi[11] = {{1, 1}};
...
;
struct __dst_alloc_list__dmemL105R __dmemL105R[2048U];
# 1 "<stdin>"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
...
typedef unsigned char __dst_alloc_bucket_size_t;
# 73 "<stdin>"
unsigned char __dst_alloc_node_split__dmemL105R[(1 << (11 - 1)) / 8];
...
struct __dst_alloc_list_base_t __dst_alloc_buckets__dmemL105R[11] = {{1, 1}};
