...
int find_min( int in0, int in1, int in2 )
{
  if (in0 < in1)
  {
    if (in0 < in2)
...
int find_max( int in0, int in1, int in2 )
{
  if (in0 > in1)
  {
    if (in0 > in2)
...
int rasterization2 ( bool flag, int max_min[], int max_index[], Triangle_2D triangle_2d, CandidatePixel fragment[] )
{
  // clockwise the vertices of input 2d triangle
  if ( flag )
  {
...
void coloringFB(int counter, int size_pixels, Pixel pixels[], int frame_buffer[MAX_X][MAX_Y])
{
