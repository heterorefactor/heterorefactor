...
#undef CTOR
    ...
    ap_int<_AP_W> & operator()(ap_int<_AP_W> i, ap_int<_AP_W> j) { return dummy; }
    ap_uint<_AP_W> & range(ap_uint<_AP_W> i, ap_uint<_AP_W> j) { return dummy; }
    ap_uint<_AP_W> & operator()(ap_uint<_AP_W> i, ap_uint<_AP_W> j) { return dummy; }
