...
#undef CTOR    
    ap_private(const ap_private & op) {};
    ap_private(const volatile ap_private & op) {};
    ap_private() {};
};
...
class ap_fixed_base {
    public:
    ap_fixed_base() {};
    template<int _AP_W1, int _AP_I1, bool _AP_S1, ap_q_mode _AP_Q1,
             ap_o_mode _AP_O1, int _AP_N1>
    INLINE ap_fixed_base(const ap_fixed_base<_AP_W1, _AP_I1, _AP_S1, _AP_Q1,
                     _AP_O1, _AP_N1>& op) {}
 #define CTOR(TYPE) \
    INLINE ap_fixed_base(TYPE v) {}
    CTOR(bool)
    CTOR(signed char)
    CTOR(unsigned char)
    CTOR(short)
...
#undef CTOR    
    ...
    INLINE ap_fixed_base<_AP_W2,_AP_I2,_AP_S2,_AP_Q2,_AP_O2, _AP_N2> operator * (const ap_fixed_base<_AP_W2,_AP_I2,_AP_S2,_AP_Q2,_AP_O2, _AP_N2>& op2) const {
        ap_fixed_base<_AP_W2,_AP_I2,_AP_S2,_AP_Q2,_AP_O2, _AP_N2> r;
        return r;
    }
    INLINE ap_fixed_base<_AP_W2,_AP_I2,_AP_S2,_AP_Q2,_AP_O2, _AP_N2> operator - (const ap_fixed_base<_AP_W2,_AP_I2,_AP_S2,_AP_Q2,_AP_O2, _AP_N2>& op2) const {
        ap_fixed_base<_AP_W2,_AP_I2,_AP_S2,_AP_Q2,_AP_O2, _AP_N2> r;
...
#undef CTOR
    ...
    int & range(int i, int j) { return dummy; }
    int & range() { return dummy; }
    int & operator()(int i, int j) { return range(i, j); }

    //ykchoi
    //ap_int<_AP_W> & range( ap_int<_AP_W> i,  ap_int<_AP_W> j) { return dummy; }
    //ap_int<_AP_W> & operator()( ap_int<_AP_W> i,  ap_int<_AP_W> j) { return range(i, j); }

  INLINE bool operator >= (const ap_uint<_AP_W>& op2) const {
        return !(*this<op2);
    }
    INLINE bool operator > (const ap_uint<_AP_W>& op2) const {
        return !(*this<op2);
    ...
    INLINE ap_int<_AP_W> operator * (const ap_int<_AP_W> & op2) const {
        ap_int<_AP_W> r;
        return r;
    }
    INLINE ap_int<_AP_W> operator * (const int & op2) const {
        ap_int<_AP_W> r;
        return r;
    }
    INLINE ap_int<_AP_W> operator + (const ap_int<_AP_W> & op2) const {
...
/*
   INLINE ap_int<_AP_W> & range(int i, int j) const {
        ap_int<_AP_W> r;
        return r;
    }

   INLINE ap_int<_AP_W> & range() const {
        ap_int<_AP_W> r;
        return r;
    }

   INLINE ap_int<_AP_W> & operator () (int i, int j) const {
        ap_int<_AP_W> r;
        return r;
    }
*/
...
public:
  ...
  INLINE ap_uint(const volatile ap_uint<_AP_W>& op):Base(dynamic_cast<const volatile ap_private<_AP_W, false>&>(op)){}
    template<int _AP_W2>
    INLINE ap_uint(const volatile ap_uint<_AP_W2> &op):Base((const ap_private<_AP_W, false>&)(op)) {}

    template<int _AP_W2>
    INLINE ap_uint(const ap_uint<_AP_W2> &op) : Base((const ap_private<_AP_W, false>&)(op)){}

    template<int _AP_W2>
    INLINE ap_uint(const ap_int<_AP_W2> &op) : Base((const ap_private<_AP_W, true>&)(op)) {}

    template<int _AP_W2>
    INLINE ap_uint(const volatile ap_int<_AP_W2> &op) : Base((const ap_private<_AP_W, false>&)(op)) {}
...
#undef CTOR    
    ...
    INLINE ap_uint<_AP_W>& operator = (const int & op2) {
      //Base::operator = ((const ap_private<_AP_W, false>&)(op2));
        return *this;
    }

   INLINE ap_uint<_AP_W>& operator = (const unsigned int & op2) {
      //Base::operator = ((const ap_private<_AP_W, false>&)(op2));
        return *this;
    }
   ...
   INLINE bool operator != (const ap_uint<_AP_W>& op2) {
        return !(*this<op2);
    }
   ...
   //ykchoi
    ...
    INLINE bool operator == (const ap_int<_AP_W>& op2) const {
        return !(*this<op2);
    }
    INLINE bool operator == (const ap_uint<_AP_W>& op2) const {
        return !(*this<op2);
   ...
   INLINE bool operator == (const int & op2) const {
        return !(*this<op2);
    }

    INLINE ap_uint<_AP_W> operator * (const int & op2) const {
        ap_uint<_AP_W> r;
        return r;
    }
    INLINE ap_uint<_AP_W> operator + (const ap_uint<_AP_W> & op2) const {
        ap_uint<_AP_W> r;
        return r;
    }
 
    INLINE ap_uint<_AP_W> operator - (const ap_int<_AP_W> & op2) const {
        ap_uint<_AP_W> r;
        return r;
    }
   ...
   INLINE ap_uint<_AP_W> operator | (const ap_uint<_AP_W> & op2) const {
    ...
    INLINE ap_uint<_AP_W> operator ++(int op2) const { 
        ap_uint<_AP_W> r;
         return r;
    }
   ...
   INLINE ap_uint<_AP_W> range(int i, int j) const {
        ap_uint<_AP_W> r;
        return r;
    }

   INLINE ap_uint<_AP_W> range() const {
        ap_uint<_AP_W> r;
        return r;
    }

   INLINE ap_uint<_AP_W> operator () (int i, int j) const {
        ap_uint<_AP_W> r;
        return r;
    }
...
/*
    ...
    int & range(const ap_uint<_AP_W> & op2, const ap_uint<_AP_W> & op3) { return dummy; }
    int & operator()(const ap_uint<_AP_W> & op2, const ap_uint<_AP_W> & op3) { return dummy; }
*/
};
